...
TARGETS: dict[str, tuple[int, int] | None] = {
    ...
    "assets/resources/ui/common/hud-bar-frame-v2.png": (560, 50),
    ...
    "assets/resources/ui/hud-panel-top-v2.png": (1200, 180),
    "assets/resources/ui/start/start-bg-wasteland-v1.png": None,
    "assets/resources/ui/game/battle-bg-road-v1.png": None,
    "assets/resources/ui/game/battle-bg-road-supply-lane-v3.png": (720, 1280),
    "assets/resources/ui/game/battle-divider-lane-v2.png": (180, 1280),
    "assets/resources/ui/game/chests_v2/chest_firepower_v2.png": (320, 220),
    "assets/resources/ui/game/chests_v2/chest_control_v2.png": (320, 220),
    "assets/resources/ui/game/chests_v2/chest_elite_v2.png": (320, 220),
    "assets/resources/ui/game/chests_v2/chest_rare_v2.png": (320, 220),
